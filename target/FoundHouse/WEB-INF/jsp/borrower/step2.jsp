					...
					<form novalidate="novalidate" id="signup_form" method="post">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div
									...
									<select class="mdl-selectfield__select" name="loanPurpose"
										id="loan_pupose" required>
										<option value="" selected="selected"></option>
										<option value='6'>Appliance Purchase</option>
										<option value='11'>Business Funding</option>
										<option value='9'>Car/2-wheeler Purchase</option>
										<option value='261'>Credit Card Bill Consolidation</option>
										<option value='8'>Debt Consolidation</option>
										<option value='7'>Education</option>
										<option value='129'>Family Event</option>
										<option value='21'>Home Furnishing</option>
										<option value='22'>Home Improvement</option>
										<option value='23'>Medical</option>
										<option value='24'>Travel/Vacation</option>
										<option value='25'>Wedding</option>
									</select> <label class="mdl-selectfield__label" for="loan_pupose">Loan
										Purpose</label>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div
									class="mdl-selectfield mdl-js-selectfield mdl-selectfield--floating-label">
									<select class="mdl-selectfield__select" id="loan_city"
										name="loanCity" required>
										<option value="" selected="selected"></option>
									...
									</select> <label class="mdl-selectfield__label" for="loan_city">Loan
										City</label>
								</div>
							</div>
						...
						<div class="col-md-12">
							<label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect"
								for="c4"> <input type="checkbox" id="c4" name="c4"
								class="mdl-checkbox__input"> <span
								class="mdl-checkbox__label">I agree that Fundhouse can
									share my details with affiliated NBFCs to assist in fast loan
									processing (Optional)</span>
							</label>
						</div>
