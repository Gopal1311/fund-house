			...
			<div
				...
				<form role="form" action="" method="post" class="f1">
					...
					<fieldset style="display: block;">
						...
						<div class="form-group">
							<div class="pad col-xs-6">
								<input type="text" class="form-control " placeholder="Loan city">
							</div>
							<div class="pad col-xs-6">
					...
					<fieldset>
						<center>
							<h1>Borrower : Personal Details</h1>
						</center>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="pad col-xs-4">
								<input type="text" class="form-control "
									placeholder="Numbers of Dependents">
							</div>
							<div class="pad col-xs-4">
								<input type="text" class="form-control "
						...
						<div class="form-group">
							<div class="pad col-xs-6">
								<input type="text" class="form-control "
									placeholder="WHEN DID YOU MOVE TO 
THE CURRENT CITY">
							</div>
							<div class="pad col-xs-6">
								<input type="text" class="form-control "
